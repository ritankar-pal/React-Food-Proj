...
const RestaurantMenu = () => {
  ...
  //Accordion of <RestaurantCategory/>
  ...
  const categories = allMenus.filter(
    (elem) =>
      elem.card.card["@type"] ===
  ...
  return (
    <div className="text-center m-4 p-4">
      ...
      <h3 className="resHeading" style={{ color: "grey" }}>
